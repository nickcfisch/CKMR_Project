...
##Ncomp 100, index sd 0.25, no ckmr, 20yrs 
...
for (Q in NULL){  #Running through the life history types
  for (s in N_sim){
   ...
   if(Q==1){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Cod_N100_Ind25_20yrs_noCKMR.RData"))
   } else if (Q==2){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Flatfish_N100_Ind25_20yrs_noCKMR.RData"))
   } else if (Q==3){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Sardine_N100_Ind25_20yrs_noCKMR.RData"))
   }  
}

#Ncomp 1000, index sd 0.50, no ckmr, 5yrs 
...
for (Q in NULL){  #Running through the life history types
  for (s in N_sim){
   ...
   if(Q==1){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Cod_N1000_Ind50_5yrs_noCKMR.RData"))
   } else if (Q==2){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Flatfish_N1000_Ind50_5yrs_noCKMR.RData"))
   } else if (Q==3){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Sardine_N1000_Ind50_5yrs_noCKMR.RData"))
   }  
}

#Ncomp 5000, index sd 0.25, no ckmr, 20yrs 
...
for (Q in 1:3){  #Running through the life history types
  for (s in N_sim){
   ...
   if(Q==1){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Cod_N5000_Ind25_20yrs_noCKMR.RData"))
   } else if (Q==2){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Flatfish_N5000_Ind25_20yrs_noCKMR.RData"))
   } else if (Q==3){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Sardine_N5000_Ind25_20yrs_noCKMR.RData"))
   }  
}
