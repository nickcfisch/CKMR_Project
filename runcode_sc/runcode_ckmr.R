...
#Ncomp 1000, sdindex 0.25, ckmr 20yrs
...
for (Q in NULL){  #Running through the life history types
  for (s in N_sim){
   ...
   if(Q==1){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Cod_N1000_Ind25_ckmrmultinom20.RData"))
   } else if (Q==2){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Flatfish_N1000_Ind25_ckmrmultinom20.RData"))
   } else if (Q==3){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Sardine_N1000_Ind25_ckmrmultinom20.RData"))
   }  
}

#Ncomp 5000, sdindex 0.50, ckmr 20yrs
...
for (Q in 3:3){  #Running through the life history types
  for (s in N_sim){
   ...
   if(Q==1){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Cod_N5000_Ind50_ckmrmultinom20.RData"))
   } else if (Q==2){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Flatfish_N5000_Ind50_ckmrmultinom20.RData"))
   } else if (Q==3){
   saveRDS(res_list, file=paste0(wd,"/results/SCAAfit_Sardine_N5000_Ind50_ckmrmultinom20.RData"))
   }  
}
