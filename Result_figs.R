...
# #N200 for 5yrs, sd index 0.25
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N200_Ind25_5yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N200_Ind25_5yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N200_Ind25_5yrs_noCKMR.RData"))
# 
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N200_Ind25_5yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N200_Ind25_5yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N200_Ind25_5yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N200_Ind25_5yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N200_Ind25_5yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N200_Ind25_5yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N200_Ind25_5yrs_noCKMR<-CV_ssb_N200_Ind25_5yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N200_Ind25_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N200_Ind25_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N200_Ind25_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N200_Ind25_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N200_Ind25_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N200_Ind25_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N2000 for 5 yrs, sd index 0.25
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N2000_Ind25_5yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N2000_Ind25_5yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N2000_Ind25_5yrs_noCKMR.RData"))
# 
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N2000_Ind25_5yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N2000_Ind25_5yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N2000_Ind25_5yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N2000_Ind25_5yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N2000_Ind25_5yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N2000_Ind25_5yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N2000_Ind25_5yrs_noCKMR<-CV_ssb_N2000_Ind25_5yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N2000_Ind25_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N2000_Ind25_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N2000_Ind25_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N2000_Ind25_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N2000_Ind25_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N2000_Ind25_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N200 for 5 yrs, sd index 0.50
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N200_Ind50_5yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N200_Ind50_5yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N200_Ind50_5yrs_noCKMR.RData"))
# 
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N200_Ind50_5yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N200_Ind50_5yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N200_Ind50_5yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N200_Ind50_5yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N200_Ind50_5yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N200_Ind50_5yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N200_Ind50_5yrs_noCKMR<-CV_ssb_N200_Ind50_5yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N200_Ind50_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N200_Ind50_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N200_Ind50_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N200_Ind50_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N200_Ind50_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N200_Ind50_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N2000 for 5yrs, sd index 0.50
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N2000_Ind50_5yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N2000_Ind50_5yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N2000_Ind50_5yrs_noCKMR.RData"))
# 
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N2000_Ind50_5yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N2000_Ind50_5yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N2000_Ind50_5yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N2000_Ind50_5yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N2000_Ind50_5yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N2000_Ind50_5yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N2000_Ind50_5yrs_noCKMR<-CV_ssb_N2000_Ind50_5yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N2000_Ind50_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N2000_Ind50_5yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N2000_Ind50_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N2000_Ind50_5yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N2000_Ind50_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N2000_Ind50_5yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N200 for 10yrs, sd index 0.25
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N200_Ind25_10yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N200_Ind25_10yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N200_Ind25_10yrs_noCKMR.RData"))
# 
# Cod_wdat<-Cod_200_25_10
# Flatfish_wdat<-Flatfish_200_25_10
# Sardine_wdat<-Sardine_200_25_10
# 
# re_Dep<-re_SSB<-array(NA, dim=c(3,100,76))
# re_R0<-re_M<-matrix(NA, nrow=100, ncol=3)
# for(f in 1:3){
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N200_Ind25_10yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N200_Ind25_10yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N200_Ind25_10yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N200_Ind25_10yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N200_Ind25_10yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N200_Ind25_10yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N200_Ind25_10yrs_noCKMR<-CV_ssb_N200_Ind25_10yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N200_Ind25_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N200_Ind25_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N200_Ind25_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N200_Ind25_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N200_Ind25_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N200_Ind25_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N2000 for 10 yrs, sd index 0.25
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N2000_Ind25_10yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N2000_Ind25_10yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N2000_Ind25_10yrs_noCKMR.RData"))
# 
# Cod_wdat<-Cod_2000_25_10
# Flatfish_wdat<-Flatfish_2000_25_10
# Sardine_wdat<-Sardine_2000_25_10
# 
# re_Dep<-re_SSB<-array(NA, dim=c(3,100,76))
# re_R0<-re_M<-matrix(NA, nrow=100, ncol=3)
# for(f in 1:3){
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N2000_Ind25_10yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N2000_Ind25_10yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N2000_Ind25_10yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N2000_Ind25_10yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N2000_Ind25_10yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N2000_Ind25_10yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N2000_Ind25_10yrs_noCKMR<-CV_ssb_N2000_Ind25_10yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N2000_Ind25_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N2000_Ind25_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N2000_Ind25_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N2000_Ind25_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N2000_Ind25_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N2000_Ind25_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N200 for 10yrs, sd index 0.50
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N200_Ind50_10yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N200_Ind50_10yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N200_Ind50_10yrs_noCKMR.RData"))
# 
# Cod_wdat<-Cod_200_50_10
# Flatfish_wdat<-Flatfish_200_50_10
# Sardine_wdat<-Sardine_200_50_10
# 
# re_Dep<-re_SSB<-array(NA, dim=c(3,100,76))
# re_R0<-re_M<-matrix(NA, nrow=100, ncol=3)
# for(f in 1:3){
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N200_Ind50_10yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N200_Ind50_10yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N200_Ind50_10yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N200_Ind50_10yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N200_Ind50_10yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N200_Ind50_10yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N200_Ind50_10yrs_noCKMR<-CV_ssb_N200_Ind50_10yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N200_Ind50_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N200_Ind50_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N200_Ind50_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N200_Ind50_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N200_Ind50_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N200_Ind50_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
# #N2000 for 10yrs, sd index 0.50
# res_list[[1]]<-readRDS(paste0(wd,"/SCAAfit_Cod_N2000_Ind50_10yrs_noCKMR.RData"))
# res_list[[2]]<-readRDS(paste0(wd,"/SCAAfit_Flatfish_N2000_Ind50_10yrs_noCKMR.RData"))
# res_list[[3]]<-readRDS(paste0(wd,"/SCAAfit_Sardine_N2000_Ind50_10yrs_noCKMR.RData"))
# 
# Cod_wdat<-Cod_2000_50_10
# Flatfish_wdat<-Flatfish_2000_50_10
# Sardine_wdat<-Sardine_2000_50_10
# 
# re_Dep<-re_SSB<-array(NA, dim=c(3,100,76))
# re_R0<-re_M<-matrix(NA, nrow=100, ncol=3)
# for(f in 1:3){
...
# 
# #Variance of relative error for point estimates
# sd_RE_ssb_N2000_Ind50_10yrs_noCKMR<-apply(re_SSB,c(1,3),sd)
# sd_RE_R0_N2000_Ind50_10yrs_noCKMR<-apply(re_R0,2,sd)
# sd_RE_M_N2000_Ind50_10yrs_noCKMR<-apply(re_M,2,sd)
# 
# #variance of absolute relative error
# sd_ARE_ssb_N2000_Ind50_10yrs_noCKMR<-apply(abs(re_SSB),c(1,3),sd)
# sd_ARE_R0_N2000_Ind50_10yrs_noCKMR<-apply(abs(re_R0),2,sd)
# sd_ARE_M_N2000_Ind50_10yrs_noCKMR<-apply(abs(re_M),2,sd)
# 
# #Precision within sims
# SD_ssb_N2000_Ind50_10yrs_noCKMR<-CV_ssb_N2000_Ind50_10yrs_noCKMR<-array(NA, dim=c(3,100,76)) 
# SD_R0_N2000_Ind50_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# SD_M_N2000_Ind50_10yrs_noCKMR<-matrix(NA, nrow=3, ncol=100)
# for(f in 1:3){
#   for (i in 1:100){
#     CV_ssb_N2000_Ind50_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd/res_list[[f]][[i]]$SD$unbiased$value
#     SD_ssb_N2000_Ind50_10yrs_noCKMR[f,i,]<-res_list[[f]][[i]]$SD$sd
#     SD_R0_N2000_Ind50_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_R0","log_R0"])
#     SD_M_N2000_Ind50_10yrs_noCKMR[f,i]<-sqrt(res_list[[f]][[i]]$SD$cov.fixed["log_M","log_M"])
#   }
# }
...
boxplot(CV_ssb_N100_Ind25[1,,], add=TRUE, ylim=c(0,0.15), las=1, main="", col=2)
...
boxplot(CV_ssb_N1000_Ind25[1,,], add=TRUE, ylim=c(0,0.15), las=1, main="", col=2)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom10[1,,], add=TRUE, ylim=c(0,0.15), las=1, main="", col=3)
legend("top",c("No CKMR","5yrs CKMR", "10yrs CKMR"), pch=15, col=1:3)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom5[1,,], ylim=c(0,0.15), las=1, main="Cod - N5000")
boxplot(CV_ssb_N5000_Ind25[1,,], add=TRUE, ylim=c(0,0.15), las=1, main="", col=2)
...
boxplot(CV_ssb_N100_Ind25[2,,], add=TRUE, ylim=c(0,0.18), las=1, main="", col=2)
...
boxplot(CV_ssb_N1000_Ind25[2,,], add=TRUE, ylim=c(0,0.18), las=1, main="", col=2)
...
boxplot(CV_ssb_N5000_Ind25[2,,], add=TRUE, ylim=c(0,0.18), las=1, main="", col=2)
...
boxplot(CV_ssb_N100_Ind25[3,,], add=TRUE, ylim=c(0,0.23), las=1, main="", col=2)
...
boxplot(CV_ssb_N1000_Ind25[3,,], add=TRUE, ylim=c(0,0.23), las=1, main="", col=2)
...
boxplot(CV_ssb_N5000_Ind25[3,,], add=TRUE, ylim=c(0,0.23), las=1, main="", col=2)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom10[3,,], add=TRUE, ylim=c(0,0.15), las=1, main="", col=3)

#Relative to models with no ckmr
par(mfrow=c(3,3), mar=c(3,4,1,1), oma=c(2,2,1,1))
boxplot(CV_ssb_N100_Ind25_ckmrmultinom5[1,,]/CV_ssb_N100_Ind25[1,,], ylim=c(0.95,1.05), las=1, main="Cod - N100", col=2)
boxplot(CV_ssb_N100_Ind25_ckmrmultinom10[1,,]/CV_ssb_N100_Ind25[1,,], add=TRUE, ylim=c(0.95,1.05), las=1, main="", col=3)
legend("top",c("5yrs CKMR", "10yrs CKMR"), pch=15, col=c(2,3))
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom5[1,,]/CV_ssb_N1000_Ind25[1,,], ylim=c(0.75,1.05), las=1, main="Cod - N1000", col=2)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom10[1,,]/CV_ssb_N1000_Ind25[1,,], add=TRUE, ylim=c(0.75,1.05), las=1, main="", col=3)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom5[1,,]/CV_ssb_N5000_Ind25[1,,], ylim=c(0.75,1.05), las=1, main="Cod - N5000", col=2)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom10[1,,]/CV_ssb_N5000_Ind25[1,,], add=TRUE, ylim=c(0.75,1.05), las=1, main="", col=3)

boxplot(CV_ssb_N100_Ind25_ckmrmultinom5[2,,]/CV_ssb_N100_Ind25[2,,], ylim=c(0.95,1.05), las=1, main="Flatfish - N100", ylab="CV of SSB relative to no CKMR Model", col=2)
boxplot(CV_ssb_N100_Ind25_ckmrmultinom10[2,,]/CV_ssb_N100_Ind25[2,,], add=TRUE, ylim=c(0.95,1.05), las=1, main="", col=3)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom5[2,,]/CV_ssb_N1000_Ind25[2,,], ylim=c(0.35,1.05), las=1, main="Flatfish - N1000", col=2)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom10[2,,]/CV_ssb_N1000_Ind25[2,,], add=TRUE, ylim=c(0.35,1.05), las=1, main="", col=3)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom5[2,,]/CV_ssb_N5000_Ind25[2,,], ylim=c(0.15,1.05), las=1, main="Flatfish - N5000", col=2)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom10[2,,]/CV_ssb_N5000_Ind25[2,,], add=TRUE, ylim=c(0.15,1.05), las=1, main="", col=3)

boxplot(CV_ssb_N100_Ind25_ckmrmultinom5[3,,]/CV_ssb_N100_Ind25[3,,], ylim=c(0.95,1.05), las=1, main="Sardine - N100", col=2)
boxplot(CV_ssb_N100_Ind25_ckmrmultinom10[3,,]/CV_ssb_N100_Ind25[3,,], add=TRUE, ylim=c(0.95,1.05), las=1, main="", col=3)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom5[3,,]/CV_ssb_N1000_Ind25[3,,], ylim=c(0.5,1.05), las=1, main="Sardine - N1000", col=2)
boxplot(CV_ssb_N1000_Ind25_ckmrmultinom10[3,,]/CV_ssb_N1000_Ind25[3,,], add=TRUE, ylim=c(0.5,1.05), las=1, main="", col=3)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom5[3,,]/CV_ssb_N5000_Ind25[3,,], ylim=c(0.5,1.05), las=1, main="Sardine - N5000", col=2)
boxplot(CV_ssb_N5000_Ind25_ckmrmultinom10[3,,]/CV_ssb_N5000_Ind25[3,,], add=TRUE, ylim=c(0.5,1.05), las=1, main="", col=3)

#R0
par(mfcol=c(3,3), mar=c(3,4,1,1), oma=c(2,2,1,1))
boxplot(cbind(SD_R0_N100_Ind25[1,],SD_R0_N100_Ind25_ckmrmultinom5[1,],SD_R0_N100_Ind25_ckmrmultinom10[1,]), ylim=c(0.07,0.11), las=1, main="Cod - SD log(R0) - N100", xaxt="n")
boxplot(cbind(SD_R0_N100_Ind25[2,],SD_R0_N100_Ind25_ckmrmultinom5[2,],SD_R0_N100_Ind25_ckmrmultinom10[2,]), ylim=c(0.08,0.17), las=1, main="Flatfish - SD log(R0) - N100", ylab="SD of log(R0)", xaxt="n")
boxplot(cbind(SD_R0_N100_Ind25[3,],SD_R0_N100_Ind25_ckmrmultinom5[3,],SD_R0_N100_Ind25_ckmrmultinom10[3,]), ylim=c(0.12,0.21), las=1, main="Sardine - SD log(R0) - N100", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

boxplot(cbind(SD_R0_N1000_Ind25[1,],SD_R0_N1000_Ind25_ckmrmultinom5[1,],SD_R0_N1000_Ind25_ckmrmultinom10[1,]), ylim=c(0.07,0.11), las=1, main="Cod - SD log(R0) - N1000", xaxt="n")
boxplot(cbind(SD_R0_N1000_Ind25[2,],SD_R0_N1000_Ind25_ckmrmultinom5[2,],SD_R0_N1000_Ind25_ckmrmultinom10[2,]), ylim=c(0.08,0.17), las=1, main="Flatfish - SD log(R0) - N1000", ylab="SD of log(R0)", xaxt="n")
boxplot(cbind(SD_R0_N1000_Ind25[3,],SD_R0_N1000_Ind25_ckmrmultinom5[3,],SD_R0_N1000_Ind25_ckmrmultinom10[3,]), ylim=c(0.12,0.21), las=1, main="Sardine - SD log(R0) - N1000", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

boxplot(cbind(SD_R0_N5000_Ind25[1,],SD_R0_N5000_Ind25_ckmrmultinom5[1,],SD_R0_N5000_Ind25_ckmrmultinom10[1,]), ylim=c(0.07,0.11), las=1, main="Cod - SD log(R0) - N5000", xaxt="n")
boxplot(cbind(SD_R0_N5000_Ind25[2,],SD_R0_N5000_Ind25_ckmrmultinom5[2,],SD_R0_N5000_Ind25_ckmrmultinom10[2,]), ylim=c(0.08,0.17), las=1, main="Flatfish - SD log(R0) - N5000", ylab="SD of log(R0)", xaxt="n")
boxplot(cbind(SD_R0_N5000_Ind25[3,],SD_R0_N5000_Ind25_ckmrmultinom5[3,],SD_R0_N5000_Ind25_ckmrmultinom10[3,]), ylim=c(0.12,0.21), las=1, main="Sardine - SD log(R0) - N5000", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

#M
par(mfcol=c(3,3), mar=c(3,4,1,1), oma=c(2,2,1,1))
boxplot(cbind(SD_M_N100_Ind25[1,],SD_M_N100_Ind25_ckmrmultinom5[1,],SD_M_N100_Ind25_ckmrmultinom10[1,]), ylim=c(0.022,0.029), las=1, main="Cod - SD log(M) - N100", xaxt="n")
boxplot(cbind(SD_M_N100_Ind25[2,],SD_M_N100_Ind25_ckmrmultinom5[2,],SD_M_N100_Ind25_ckmrmultinom10[2,]), ylim=c(0.019,0.048), las=1, main="Flatfish - SD log(M) - N100", ylab="SD of log(M)", xaxt="n")
boxplot(cbind(SD_M_N100_Ind25[3,],SD_M_N100_Ind25_ckmrmultinom5[3,],SD_M_N100_Ind25_ckmrmultinom10[3,]), ylim=c(0.025,0.044), las=1, main="Sardine - SD log(M) - N100", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

boxplot(cbind(SD_M_N1000_Ind25[1,],SD_M_N1000_Ind25_ckmrmultinom5[1,],SD_M_N1000_Ind25_ckmrmultinom10[1,]), ylim=c(0.022,0.029), las=1, main="Cod - SD log(M) - N1000", xaxt="n")
boxplot(cbind(SD_M_N1000_Ind25[2,],SD_M_N1000_Ind25_ckmrmultinom5[2,],SD_M_N1000_Ind25_ckmrmultinom10[2,]), ylim=c(0.019,0.048), las=1, main="Flatfish - SD log(M) - N1000", ylab="SD of log(M)", xaxt="n")
boxplot(cbind(SD_M_N1000_Ind25[3,],SD_M_N1000_Ind25_ckmrmultinom5[3,],SD_M_N1000_Ind25_ckmrmultinom10[3,]), ylim=c(0.025,0.044), las=1, main="Sardine - SD log(M) - N1000", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

boxplot(cbind(SD_M_N5000_Ind25[1,],SD_M_N5000_Ind25_ckmrmultinom5[1,],SD_M_N5000_Ind25_ckmrmultinom10[1,]), ylim=c(0.022,0.029), las=1, main="Cod - SD log(M) - N5000", xaxt="n")
boxplot(cbind(SD_M_N5000_Ind25[2,],SD_M_N5000_Ind25_ckmrmultinom5[2,],SD_M_N5000_Ind25_ckmrmultinom10[2,]), ylim=c(0.019,0.048), las=1, main="Flatfish - SD log(M) - N5000", ylab="SD of log(M)", xaxt="n")
boxplot(cbind(SD_M_N5000_Ind25[3,],SD_M_N5000_Ind25_ckmrmultinom5[3,],SD_M_N5000_Ind25_ckmrmultinom10[3,]), ylim=c(0.025,0.044), las=1, main="Sardine - SD log(M) - N5000", xaxt="n")
axis(side=1, at=1:3, labels=c("No CKMR","CKMR 5 Years","CKMR 10 Years"))

#SD of point estimates between sims
par(mfcol=c(3,3), mar=c(3,4,1,1), oma=c(2,2,1,1))
#SD RE
plot(sd_RE_ssb_N100_Ind25[1,], pch=16, ylim=c(0,0.14), las=1, ylab="", main="Cod - N100")
points(sd_RE_ssb_N100_Ind25_ckmrmultinom5[1,], pch=16, col=2)
points(sd_RE_ssb_N100_Ind25_ckmrmultinom10[1,], pch=16, col=3)
plot(sd_RE_ssb_N100_Ind25[2,], pch=16, ylim=c(0,0.16), las=1, ylab="SD SSB RE", main="Flatfish - N100")
points(sd_RE_ssb_N100_Ind25_ckmrmultinom5[2,], pch=16, col=2)
points(sd_RE_ssb_N100_Ind25_ckmrmultinom10[2,], pch=16, col=3)
plot(sd_RE_ssb_N100_Ind25[3,], pch=16, ylim=c(0,0.20), las=1, ylab="", main="Sardine - N100")
points(sd_RE_ssb_N100_Ind25_ckmrmultinom5[3,], pch=16, col=2)
points(sd_RE_ssb_N100_Ind25_ckmrmultinom10[3,], pch=16, col=3)

plot(sd_RE_ssb_N1000_Ind25[1,], pch=16, ylim=c(0,0.14), las=1, ylab="", main="Cod - N1000")
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom5[1,], pch=16, col=2)
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom10[1,], pch=16, col=3)
legend("top", c("No CKMR", "CKMR 5 years", "CKMR 10 years"), col=1:3, pch=16)
plot(sd_RE_ssb_N1000_Ind25[2,], pch=16, ylim=c(0,0.15), las=1, ylab="SD SSB RE", main="Flatfish - N1000")
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom5[2,], pch=16, col=2)
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom10[2,], pch=16, col=3)
plot(sd_RE_ssb_N1000_Ind25[3,], pch=16, ylim=c(0,0.20), las=1, ylab="", main="Sardine - N1000")
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom5[3,], pch=16, col=2)
points(sd_RE_ssb_N1000_Ind25_ckmrmultinom10[3,], pch=16, col=3)

plot(sd_RE_ssb_N5000_Ind25[1,], pch=16, ylim=c(0,0.14), las=1, ylab="", main="Cod - N5000")
points(sd_RE_ssb_N5000_Ind25_ckmrmultinom5[1,], pch=16, col=2)
points(sd_RE_ssb_N5000_Ind25_ckmrmultinom10[1,], pch=16, col=3)
plot(sd_RE_ssb_N5000_Ind25[2,], pch=16, ylim=c(0,0.16), las=1, ylab="SD SSB RE", main="Flatfish - N5000")
points(sd_RE_ssb_N5000_Ind25_ckmrmultinom5[2,], pch=16, col=2)
points(sd_RE_ssb_N5000_Ind25_ckmrmultinom10[2,], pch=16, col=3)
plot(sd_RE_ssb_N5000_Ind25[3,], pch=16, ylim=c(0,0.20), las=1, ylab="", main="Sardine - N5000")
points(sd_RE_ssb_N5000_Ind25_ckmrmultinom5[3,], pch=16, col=2)
...
points(sd_ARE_ssb_N100_Ind25_ckmrmultinom10[1,], pch=16, col=3)
...
points(sd_ARE_ssb_N100_Ind25_ckmrmultinom10[2,], pch=16, col=3)
...
plot(sd_ARE_ssb_N1000_Ind25[1,], pch=16, ylim=c(0,0.09), las=1, ylab="", main="Cod - N1000")
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom5[1,], pch=16, col=2)
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom10[1,], pch=16, col=3)
legend("top", c("No CKMR", "CKMR 5 years", "CKMR 10 years"), col=1:3, pch=16)
plot(sd_ARE_ssb_N1000_Ind25[2,], pch=16, ylim=c(0,0.10), las=1, ylab="SD SSB ARE", main="Flatfish - N1000")
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom5[2,], pch=16, col=2)
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom10[2,], pch=16, col=3)
plot(sd_ARE_ssb_N1000_Ind25[3,], pch=16, ylim=c(0,0.15), las=1, ylab="", main="Sardine - N1000")
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom5[3,], pch=16, col=2)
points(sd_ARE_ssb_N1000_Ind25_ckmrmultinom10[3,], pch=16, col=3)

plot(sd_ARE_ssb_N5000_Ind25[1,], pch=16, ylim=c(0,0.09), las=1, ylab="", main="Cod - N5000")
points(sd_ARE_ssb_N5000_Ind25_ckmrmultinom5[1,], pch=16, col=2)
points(sd_ARE_ssb_N5000_Ind25_ckmrmultinom10[1,], pch=16, col=3)
plot(sd_ARE_ssb_N5000_Ind25[2,], pch=16, ylim=c(0,0.10), las=1, ylab="SD SSB ARE", main="Flatfish - N5000")
points(sd_ARE_ssb_N5000_Ind25_ckmrmultinom5[2,], pch=16, col=2)
points(sd_ARE_ssb_N5000_Ind25_ckmrmultinom10[2,], pch=16, col=3)
plot(sd_ARE_ssb_N5000_Ind25[3,], pch=16, ylim=c(0,0.15), las=1, ylab="", main="Sardine - N5000")
points(sd_ARE_ssb_N5000_Ind25_ckmrmultinom5[3,], pch=16, col=2)
...
plot(1:3,sd_RE_R0_N100_Ind25, ylim=c(0,0.2), las=1, ylab="SD RE log(R0)", xaxt="n", pch=16, main="N100", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_RE_R0_N100_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_R0_N100_Ind25_ckmrmultinom10, pch=16, col=3)
plot(1:3,sd_RE_R0_N1000_Ind25, ylim=c(0,0.2), las=1, ylab="", xaxt="n", pch=16, main="N1000", xlab="",xlim=c(0.5,3.5))
legend("top", c("No CKMR", "CKMR 5 years", "CKMR 10 years"), col=1:3, pch=16)
points(1:3,sd_RE_R0_N1000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_R0_N1000_Ind25_ckmrmultinom10, pch=16, col=3)
plot(1:3,sd_RE_R0_N5000_Ind25, ylim=c(0,0.2), las=1, ylab="SD RE log(R0)", xaxt="n", pch=16, main="N5000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_RE_R0_N5000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_R0_N5000_Ind25_ckmrmultinom10, pch=16, col=3)
plot(1:3,sd_ARE_R0_N100_Ind25, ylim=c(0,0.2), las=1, ylab="SD ARE log(R0)", xaxt="n", pch=16, main="N100", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_R0_N100_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_ARE_R0_N100_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1, at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_ARE_R0_N1000_Ind25, ylim=c(0,0.2), las=1, ylab="", xaxt="n", pch=16, main="N1000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_R0_N1000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_ARE_R0_N1000_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1, at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_ARE_R0_N5000_Ind25, ylim=c(0,0.2), las=1, ylab="SD ARE log(R0)", xaxt="n", pch=16, main="N5000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_R0_N5000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_ARE_R0_N5000_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1, at=1:3, labels=c("Cod", "Flatfish", "Sardine"))

#M sd of relative error between sims 
par(mfrow=c(2,3), mar=c(3,4,1,1), oma=c(2,2,1,1))
plot(1:3,sd_RE_M_N100_Ind25, ylim=c(0,0.05), las=1, ylab="SD RE log(M)", xaxt="n", pch=16, main="N100", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_RE_M_N100_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_M_N100_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1,at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_RE_M_N1000_Ind25, ylim=c(0,0.05), las=1, ylab="", xaxt="n", pch=16, main="N1000", xlab="",xlim=c(0.5,3.5))
legend("bottom", c("No CKMR", "CKMR 5 years", "CKMR 10 years"), col=1:3, pch=16)
points(1:3,sd_RE_M_N1000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_M_N1000_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1,at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_RE_M_N5000_Ind25, ylim=c(0,0.05), las=1, ylab="SD RE log(M)", xaxt="n", pch=16, main="N5000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_RE_M_N5000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_RE_M_N5000_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1,at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_ARE_M_N100_Ind25, ylim=c(0,0.05), las=1, ylab="SD ARE log(M)", xaxt="n", pch=16, main="N100", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_M_N100_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_ARE_M_N100_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1,at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_ARE_M_N1000_Ind25, ylim=c(0,0.05), las=1, ylab="", xaxt="n", pch=16, main="N1000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_M_N1000_Ind25_ckmrmultinom5, pch=16, col=2)
points(1:3,sd_ARE_M_N1000_Ind25_ckmrmultinom10, pch=16, col=3)
axis(side=1,at=1:3, labels=c("Cod", "Flatfish", "Sardine"))
plot(1:3,sd_ARE_M_N5000_Ind25, ylim=c(0,0.05), las=1, ylab="SD ARE log(M)", xaxt="n", pch=16, main="N5000", xlab="",xlim=c(0.5,3.5))
points(1:3,sd_ARE_M_N5000_Ind25_ckmrmultinom5, pch=16, col=2)
