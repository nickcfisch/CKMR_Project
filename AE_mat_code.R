...
plot(0:25,Cod_CV, main="Cod", ylab="", pch=16, las=1, ylim=c(0,1), xlab="", cex.axis=1.3, cex.main=1.5)
mtext("CV",side=2, line=3, cex=1.2)
plot(0:25,Flatfish_SD, main="Flatfish", ylab="", pch=16, las=1, ylim=c(0,2.5), xlab="Age", cex.axis=1.3, cex.main=1.5)
mtext("SD",side=2, line=3, cex=1.2)
plot(0:15,Sardine_SD, main="Sardine", ylab="", pch=16, las=1, ylim=c(0,0.75), xlab="", cex.axis=1.3, cex.main=1.5)
mtext("SD",side=2, line=3, cex=1.2)
library(PBSmodelling)
plotBubbles(t(AE_mat_Cod), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(2,25), ylim=c(2,25))
mtext("Coded Age",side=2, line=3, cex=1.2)
axis(side=1, at=1:26, labels=0:25, las=1, cex.axis=1.3)
axis(side=2, at=1:26, labels=0:25, las=1, cex.axis=1.3)
plotBubbles(t(AE_mat_Flatfish), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(2,25), ylim=c(2,25))
axis(side=1, at=1:26, labels=0:25, las=1, cex.axis=1.3)
axis(side=2, at=1:26, labels=0:25, las=1, cex.axis=1.3)
mtext("True Age",side=1, line=3, cex=1.2)
plotBubbles(t(AE_mat_Sardine), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(1.5,15.5), ylim=c(1.5,15.5))
axis(side=1, at=1:16, labels=0:15, las=1, cex.axis=1.3)
axis(side=2, at=1:16, labels=0:15, las=1, cex.axis=1.3)
#dev.off()
