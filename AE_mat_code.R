...
plot(0:25,Flatfish_SD, main="Flatfish", ylab="", pch=16, las=1, ylim=c(0,2.5), xlab="Age")
mtext("SD",side=2, line=3)
plot(0:15,Sardine_SD, main="Sardine", ylab="", pch=16, las=1, ylim=c(0,0.75), xlab="")
mtext("SD",side=2, line=3)
library(PBSmodelling)
plotBubbles(t(AE_mat_Cod), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(2,25), ylim=c(2,25))
mtext("Coded Age",side=2, line=3)
axis(side=1, at=1:26, labels=0:25, las=1, cex.axis=0.85)
axis(side=2, at=1:26, labels=0:25, las=1, cex.axis=0.85)
plotBubbles(t(AE_mat_Flatfish), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(2,25), ylim=c(2,25))
axis(side=1, at=1:26, labels=0:25, las=1, cex.axis=0.85)
axis(side=2, at=1:26, labels=0:25, las=1, cex.axis=0.85)
mtext("True Age",side=1, line=3)
plotBubbles(t(AE_mat_Sardine), xaxt="n", yaxt="n", ylab="", xlab="", size=0.125, xlim=c(1.5,15.5), ylim=c(1.5,15.5))
axis(side=1, at=1:16, labels=0:15, las=1, cex.axis=0.85)
axis(side=2, at=1:16, labels=0:15, las=1, cex.axis=0.85)
#dev.off()
