...
#  colnames(new_dat)<-c("samp_year.old","true_age.old","coded_age.old","true_born_year.old","coded_born_year.old","Tot_reprod.old","samp_year.young","true_age.young","coded_age.young","true_born_year.young","coded_born_year.young","Tot_reprod.young", "reps") #naming the columns 
  ...
  new_dat_agg<-aggregate(new_dat$reps,by=list(samp_year.old=new_dat$samp_year.old,true_age.old=new_dat$true_age.old,coded_age.old=new_dat$coded_age.old,true_born_year.old=new_dat$true_born_year.old,coded_born_year.old=new_dat$coded_born_year.old,Tot_reprod.old=new_dat$Tot_reprod.old,
                                              samp_year.young=new_dat$samp_year.young,true_age.young=new_dat$true_age.young,coded_age.young=new_dat$coded_age.young,true_born_year.young=new_dat$true_born_year.young,coded_born_year.young=new_dat$coded_born_year.young,Tot_reprod.young=new_dat$Tot_reprod.young), FUN=sum)

  new_dat_agg<-new_dat_agg[order(new_dat_agg$samp_year.old, new_dat_agg$true_age.old, new_dat_agg$coded_age.old, new_dat_agg$true_born_year.old, new_dat_agg$coded_born_year.old,
                                 new_dat_agg$samp_year.young, new_dat_agg$true_age.young,new_dat_agg$coded_age.young, new_dat_agg$true_born_year.young, new_dat_agg$coded_born_year.young),]
